            ...
            <div className="row" style={{ color: '#fff', textAlign: 'center', height: '100%' }}>
                ...
                <div className="col-md-9 col-sm-12 pe-0 ps-0">
                    <div className="card mb-3 admin-card">
                        <div className="card-header pb-4 pt-4 ps-5">Manage Book</div>
                                        ...
                                        products.length > 0 && products.map((product, index) => {
                                            return (
                                                <tr key={product._id}>
                                                    ...
                                                    <td>{product?.price}</td>
                                                    <td>
                                                        <span onClick={() => handleDeleteProduct(product._id)} style={{ cursor: 'pointer', color: 'red' }}><FontAwesomeIcon icon={faTrashAlt} /></span>
                                                    </td>
                                                </tr>
                                            )
                                        })
